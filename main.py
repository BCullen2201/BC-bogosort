...
# copies listOfNumbers into sortedNumbers, and sorts it
sortedNumbers = listOfNumbers.copy()
sortedNumbers.sort()

def checkIfSorted(): # compares listOfNumbers and sortedNumbers to see if the former is sorted
    global attempts
    ...
    if listOfNumbers != sortedNumbers:
        ...
        shuffle(listOfNumbers) # puts numbers in listOfNumbers in random order
    else:
